        ...
        <Container>
            ...
            <Row>
                <Col>
                    ...
                    <div>Guaranteed to be non-fraudulent!</div>
                </Col>
            </Row>
            <Row>
                <Col>
                ...
                <Form>
                        ...
                        {votes?.opts.map(
                            v =>
                                ...
                                type="radio"
                                id={`default-radio-` + v}>
                                    <Form.Check.Input className="btn-check" type="radio" onChange={() => setSelectionOption(v)} checked={selectedOption === v}/>
                        ...
                        ><strong>Cast Vote!</strong></Button>
