...
const t = {
    ...
    utils: {
        address: {
            ...
            tokenPaused: 'This token is paused and cannot be sent',
        },
        ccdAmount: {
    ...
    baking: {
        ...
        restakeOption: 'Added to validator stake',
        ...
        changesTakesEffectOn: 'The following changes will take effect on\n{{ effectiveTime }}',
        pendingRemove:
            'The validator will be deregistered, and the stake will be unlocked on the public balance of the account.',
        pendingChange: 'Validator stake will be lowered to',
        showKeys: 'Show keys',
    },
    transactionReceipt: {
