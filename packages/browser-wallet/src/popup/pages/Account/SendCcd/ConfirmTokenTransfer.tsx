...
export default function ConfirmTokenTransfer({ setDetailsExpanded, cost }: Props) {
    ...
    const addPendingTransaction = useSetAtom(addPendingTransactionAtom);

    const parameters = useMemo(
        () => address && getTokenTransferParameters(address, toAddress.address, tokenId, amount.microGtuAmount),
        [address]
    );
