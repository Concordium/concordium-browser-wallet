...
const t: typeof en = {
    ...
    successExplanation:
        'Din anmodning er blevet sendt til identitets udbyderen. Det kan tage tid at bekræfte din identitiet. \n\n Når din identitet er blevet bekræftet, vil du kunne åbne en konto med den.',
    ...
    reset: 'Nulstil',
    startWaitingText:
        'Din anmoding er ved at blive lavet, undgå at lukke browseren. Vi åbner en fane hvor du kan gå igennem identitets udbyderens process for at lave din identitet.',
    error: 'Fejl',
};
