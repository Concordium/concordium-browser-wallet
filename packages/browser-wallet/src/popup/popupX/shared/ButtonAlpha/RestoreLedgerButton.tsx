...
function RestoreLedgerButton({ onClick }: WalletButtonProps) {
    return (
        <button
            type="button"
            onClick={onClick}
        ...
        >
            ...
            <div style={{ textAlign: 'left' }}>
                <p style={{ fontWeight: 700, fontSize: 15, color: '#111827', margin: 0 }}>Restore Ledger Account</p>
...
export default RestoreLedgerButton;
