import { ChromeStorageKey, PendingIdentity, Theme, WalletCredential } from './types';
...
export const storedPendingIdentities = makeStorageAccessor<PendingIdentity[]>(
    'local',
    ChromeStorageKey.PendingIdentities
);
